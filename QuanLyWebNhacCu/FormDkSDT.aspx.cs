...
{
    public partial class FormDkSDT : System.Web.UI.Page
    {
        ...
        protected void btn_dangky_Click(object sender, EventArgs e)
        {
            ...
            string sqlkiemtra = "select * from TaiKhoan where UserName='" + sdt + "' ";
            ...
            else
            {
                ...
                string sqlTK;
                sqlTK = "insert into TaiKhoan values ('" + sdt + "','" + idquyen + "', '" + pass + "')";
                int ketqua = ketnoi.ExecNonQuery(sqlTK);
                string sqlKH = "insert into KhachHang values ('" + sdt + "',N'" + hoten + "', '" + sdt + "', '"+email +"', N'"+diachi+"')";
