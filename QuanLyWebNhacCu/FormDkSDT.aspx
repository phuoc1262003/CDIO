<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormDkSDT.aspx.cs" Inherits="QuanLyWebNhacCu.FormDkSDT" %>
       ...
       <table class="signin">
            ...
            <tr>
                ...
                <td class="out-txt">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" CssClass="validation" runat="server" Display="Dynamic" ControlToValidate="txt_sdt" ErrorMessage="RequiredFieldValidator" ToolTip="Vui lòng nhập số điện thoại">*</asp:RequiredFieldValidator>
            ...
            <tr>              
                <td class="out-btndky" colspan="2" align="center">
                    <asp:Button ID="btn_dangky" CssClass="in-btnDK" runat="server" OnClick="btn_dangky_Click" Text="Đăng Ký" />
                </td>
            </tr>
